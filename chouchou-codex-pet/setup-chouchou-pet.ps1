param(
    ...
    [string]$PetId = "chouchou",
    [string]$DisplayName = "Chouchou",
    [string]$Description = "A tiny cream tabby cat companion for Codex."
)
...
Write-Host "选择 Chouchou，或在输入框输入 /pet 唤起宠物。"
