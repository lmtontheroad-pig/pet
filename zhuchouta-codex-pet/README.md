...
Zhuchouta 是一组由小猪、小水獭和虎斑小猫组成的 Codex 自定义宠物。

![Zhuchouta spritesheet preview](spritesheet-preview.png)
...
安装后在 Codex 中进入 `Settings > Appearance > Pets`，选择 `Zhuchouta`。
